...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('wallet')->middleware(['auth:sanctum'])->group(function () {
        Route::get('/fund', [WalletController::class, 'initializePayment'])->name('wallet.fund');
        Route::post('/fund', [WalletController::class, 'initializePayment'])->name('wallet.fund.post');
...
Route::prefix('v1')->middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('advertise')->middleware(['web', 'auth:sanctum'])->group(function () {
